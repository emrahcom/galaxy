...
-- keep these two lines always at the top. rollback if this is a prod server.
DELETE FROM param WHERE key = 'prod' AND value = '0';
INSERT INTO param VALUES (DEFAULT, 'prod', '0');

-- param
DELETE FROM param WHERE key != 'prod';
