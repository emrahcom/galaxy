...
sed -i "s/___CONTACT_EMAIL___/$CONTACT_EMAIL/" $ROOTFS/home/api/galaxy/config.ts

sed -i "s~___KRATOS_FQDN___~$KRATOS_FQDN~" \
    $ROOTFS/home/api/galaxy/config.kratos.ts
