<script lang="ts">
  ...
  import Add from "$lib/components/pri/meeting-membership/add.svelte";
  ...
  const pr1 = getByCode("/api/pri/meeting/invite/get/bycode", code);
  const pr2 = getByCode("/api/pri/meeting/membership/check/bycode", code);
...
<!-- -------------------------------------------------------------------------->
<Subheader subheader="Subscribe to this meeting" />
